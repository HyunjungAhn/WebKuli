...
public class PageHistory {
	...
	public static String makePageHistoryFileName(FitNesseContext context, WikiPage page, TestSummary counts, long time) throws Exception {
		...
		if (page == null) {
			...
			fullPathString = page.getPageCrawler().getFullPath(page).toString();
		}

		return String.format("%s/%s/%s", context.getTestHistoryDirectory(), fullPathString, TestHistory.makeResultFileName(counts, time));
	}
