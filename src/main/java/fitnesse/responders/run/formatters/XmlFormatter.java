...
public class XmlFormatter extends BaseFormatter {
	...
	public XmlFormatter(FitNesseContext context, final WikiPage page, WriterFactory writerFactory) throws Exception {
		...
		testResponse.finalCounts = finalSummary;
	}
	...
	public void processTestResults(final String relativeTestName, TestSummary testSummary) throws Exception {
		finalSummary.add(testSummary);
	...
	public void allTestingCompleteNoRemoveStopElement(WikiPage page, TestSummary testSummary) throws Exception {
		writeResults(writerFactory.getWriter(context, page, testSummary, getTime()));
	}
