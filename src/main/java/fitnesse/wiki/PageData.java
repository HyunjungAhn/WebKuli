...
public class PageData implements Serializable {
	...
	public static final String PropertyPARALLELSUITES = "ParallelSuites";
	public static final String PropertyLASTROWTEST = "LastRowTest";

	public static final String PAGE_TYPE_ATTRIBUTE = "PageType";
	public static final String[] PAGE_TYPE_ATTRIBUTES = {NORMAL.toString(), TEST.toString(), SUITE.toString(), PARALLELSUITE.toString()};

	public static final String[] ACTION_ATTRIBUTES = {PropertyEDIT, PropertyVERSIONS, PropertyPROPERTIES, PropertyREFACTOR, PropertyWHERE_USED, PropertyLASTROWTEST};

	public static final String[] NAVIGATION_ATTRIBUTES = {PropertyRECENT_CHANGES, PropertyFILES, PropertySEARCH, PropertyPRUNE};

	public static final String CONCURRENT_CONTEST = "ConTest";
	public static final String[] CONCURRENCY_ATTRIBUTES = {CONCURRENT_CONTEST};

	public static final String WEBDRIVER = "SmartBox";
	public static final String[] WEBDRIVER_ATTRIBUTES = {WEBDRIVER};
